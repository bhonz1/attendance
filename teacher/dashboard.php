                ...
                <?php if (is_array($classes) && count($classes)>0): ?>
                  <?php foreach ($classes as $c): ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-light btn-sm add-student-btn action-btn" href="/teacher/add_student.php?class=<?= htmlspecialchars((string)($c["id"] ?? "")) ?>&return=<?= rawurlencode('/teacher/classes.php?class=' . (string)($c["id"] ?? "")) ?>" title="Add Students" aria-label="Add Students">Add Students</a>
                        <a class="btn btn-light btn-sm view-btn action-btn" href="/teacher/classes.php?class=<?= htmlspecialchars((string)($c["id"] ?? "")) ?>" title="View Class" aria-label="View Class">View Class</a>
                        <a class="btn btn-primary btn-sm action-btn" href="/teacher/attendance.php?class=<?= htmlspecialchars((string)($c["id"] ?? "")) ?>" title="Attendance" aria-label="Attendance">Attendance</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php else: ?>
