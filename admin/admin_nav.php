  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="adminTopNav">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item"><a class="nav-link<?= ($active === 'settings' ? ' active' : '') ?>" href="/admin/setting.php">Settings</a></li>
        <li class="nav-item"><a class="nav-link<?= ($active === 'teacher' ? ' active' : '') ?>" href="/admin/teacher.php">Teacher</a></li>
        <li class="nav-item"><a class="nav-link<?= ($active === 'profile' ? ' active' : '') ?>" href="/admin/profile.php">Profile</a></li>
      </ul>
      <div class="d-flex">
